...
export default async function handler(req, res) {
    ...
    try {
        ...
        const forcedQuestions = [
            ...
            { id: 203, sandbox:'AN', qtype:'Q1', opts:['A. 一个稳定的方向 and 身份锚点——让我知道自己一直在积累','B. 清晰的规划 and 阶段目标——每一步都踏在预定的轨道上','C. 不断有新的机会 and 可能性打开——让我的世界变得更大','D. 持续突破瓶颈的快感——冲不过去的东西让我兴奋','E. 跳出来重新定义"成长"本身——不被旧路径锁死'] },
            ...
            { id: 210, sandbox:'IN', qtype:'Q2', opts:['A. 被持续误解或贴上不准确的标签——之后我不再让外部评价定义我','B. 因为不合群或坚持立场缺陷而付出代价——之后我减少了出头','C. 曾经争取位置但发现规则不公——之后我退出了','D. 我似乎从未真正关心过自己在群体里的位置','E. 我在群体里一直能被人看到真实的样子——没有退避'] },
