...
export default async function handler(req, res) {
    try {
        ...
        const forcedQuestions = [
            ...
            { id: 201, sandbox:'PN', qtype:'Q2', opts:['A. 身体和精力的透支——那之后我对消耗变得格外警惕','B. 资源突然缩减——经历过一次不安全之后，我对储备特别在意','C. 身体被困住动不了——那让关系像被活埋','D. 长期处于匮乏但没崩溃的灰色状态——慢性消耗比一次爆发更折磨','E. 身体被过度关注——我不太愿意把注意力放在身体感受上'] },
            ...
            { id: 209, sandbox:'IN', qtype:'Q1', opts:['A. 一个稳定的位置 and 归属感——让我在群体里有落点','B. 清楚的规则 and 角色——让我知道怎样不乱位','C. 足够大的活动半径 and 辐射力——让更多人看到我','D. 能表达、竞争 and 争取位置的冲动——让力不被动吞没','E. 跳出评价看透群体结构——不被舆论牵着走'] },
            { id: 210, sandbox:'IN', qtype:'Q2', opts:['A. 被持续误解或贴上不准确的标签——之后我不再让外部评价定义我','B. 因为不合群或坚持立场而付出代价——之后我减少了出头','C. 曾经争取位置打牢基础但发现规则不公——之后我退出了','D. 我似乎从未真正关心过自己在群体里的位置','E. 我在群体里一直能被人看到真实的样子——没有退避'] },
        ...
        for (let i = 0; i < engines.length; i++) {
            for (let j = 0; j < engines.length; j++) {
                ...
                if (keMap[a] === b && isWang(a) && isWang(b)) {
